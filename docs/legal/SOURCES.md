...
| Date opened | Document | URL | Notes |
|---|---|---|---|
| _TBD_ | Neptun student login / terms | https://neptun.elte.hu/ | |
| _TBD_ | ELTE IT / SZMSZ regulations | _add after reading_ | |

If terms forbid third-party clients, do not run a public beta. See [PLAN.md](../PLAN.md) §7.
